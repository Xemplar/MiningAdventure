...
public class Material extends Item implements Sellable{
	protected final int worth;
	
	protected Material(int id, int maxStack, String regionID, int worth){
        super(id, maxStack, regionID);
        this.worth = worth;
    }
	
	public Material clone(){
        return new Material(id, maxStack, regionID, worth);
    }

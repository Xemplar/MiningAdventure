...
public class SplashScreen implements Screen {
    ...
    public SplashScreen(){
        ...
        MiningAdventure.label = label = gen.generateFont(params);
        MiningAdventure.text = gen.generateFont(params);
    ...
    public void resize(int width, int height) {
        ...
        params.size = (int) (((float)height / MiningAdventure.BUTTON_HEIGHT) / 2);
        params.color = new Color(0, 0, 0, 1);
        MiningAdventure.label = gen.generateFont(params);
        
        label = gen.generateFont(params);
        label.setColor(0, 0, 0, 1);
        
        params.size = (int) (((float)height / MiningAdventure.BUTTON_HEIGHT) / 3);
    ...
    public void show() {
        Timer.Task task = new Timer.Task(){
            public void run() {
                MiningAdventure.mining.setScreen(new StartScreen());
            }
        };
